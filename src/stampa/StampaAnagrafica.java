...
//                tot[i].setBorder(BORDER_TOP_RIGHT);
        ...
        for (Fornitore anagrafe : fornitoriClienti) {
            riga = new PdfPCell[] {
                ...
                new PdfPCell(new Phrase(anagrafe.getIndirizzo() + ", " + anagrafe.getCitta() + "(" + anagrafe.getProv() + ")", FONT_GRANDE_NORMALE)),
            };
    ...
    private void stampaSingolo() throws DocumentException, IOException {
        ...
        String cap = anagrafe.getCap();
        String citta = anagrafe.getCitta();
        String prov = anagrafe.getProv();
        String nazione = anagrafe.getNazione();
        ...
        PdfPCell[] tabella = {
                    ...
                    new PdfPCell(new Phrase("Indirizzo", FONT_GRANDE_BOLD)),
                    new PdfPCell(new Phrase((indirizzo != null) ? indirizzo : "-", FONT_GRANDE_NORMALE)),
                    new PdfPCell(new Phrase("CAP", FONT_GRANDE_BOLD)),
                    new PdfPCell(new Phrase((cap != null) ? cap : "-", FONT_GRANDE_NORMALE)),
                    new PdfPCell(new Phrase("Città", FONT_GRANDE_BOLD)),
                    new PdfPCell(new Phrase((citta != null) ? citta : "-", FONT_GRANDE_NORMALE)),
                    new PdfPCell(new Phrase("Provincia", FONT_GRANDE_BOLD)),
                    new PdfPCell(new Phrase((prov != null) ? prov : "-", FONT_GRANDE_NORMALE)),
                    new PdfPCell(new Phrase("Nazione", FONT_GRANDE_BOLD)),
                    new PdfPCell(new Phrase((nazione != null) ? nazione : "-", FONT_GRANDE_NORMALE)),
                    new PdfPCell(new Phrase("Nome Ref. 1", FONT_GRANDE_BOLD)),
                    new PdfPCell(new Phrase((nomeRef1 != null) ? nomeRef1 : "-", FONT_GRANDE_NORMALE)),
                    new PdfPCell(new Phrase("E-mail Ref. 1", FONT_GRANDE_BOLD)),
                    new PdfPCell(new Phrase((emailRef1 != null) ? emailRef1 : "-", FONT_GRANDE_NORMALE)),
                    new PdfPCell(new Phrase("Tel. Ref. 1", FONT_GRANDE_BOLD)),
                    new PdfPCell(new Phrase((telRef1 != null) ? telRef1 : "-", FONT_GRANDE_NORMALE)),
                    new PdfPCell(new Phrase("Nome Ref. 2", FONT_GRANDE_BOLD)),
                    new PdfPCell(new Phrase((nomeRef2 != null) ? nomeRef2 : "-", FONT_GRANDE_NORMALE)),
                    new PdfPCell(new Phrase("E-mail Ref. 2", FONT_GRANDE_BOLD)),
                    new PdfPCell(new Phrase((emailRef2 != null) ? emailRef2 : "-", FONT_GRANDE_NORMALE)),
                    new PdfPCell(new Phrase("Tel. Ref. 2", FONT_GRANDE_BOLD)),

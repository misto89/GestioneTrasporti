...
public class StampaMovimentazioneMensile extends StampaDocumento {
    ...
    public StampaMovimentazioneMensile(int anno, List saldi, tipo tipo, String[] totali) throws DocumentException {
        super(FILENAME);
        this.anno = anno;
        this.saldi = saldi;
        this.tipoS = tipo;
    ...
    public StampaMovimentazioneMensile(Fornitore forn_cliente, int anno, List saldi, tipo tipo, String[] totali) throws DocumentException {
        this(anno, saldi, tipo, totali);
        this.forn_cliente = forn_cliente;
    }

    public StampaMovimentazioneMensile(Date dataI, Date dataF, List saldi, tipo tipo, String[] totali) throws DocumentException {
        super(FILENAME);
        this.saldi = saldi;
        this.tipoS = tipo;
    ...
    public StampaMovimentazioneMensile(Fornitore forn_cliente, Date dataI, Date dataF, List saldi, tipo tipo, String[] totali) throws DocumentException {
